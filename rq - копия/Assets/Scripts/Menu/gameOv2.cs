...
public class gameOv2 : MonoBehaviour {
	...
	void Update () {
		if (GameObject.Find ("Player") == null) {
			return;}
		if (GameObject.Find ("Player").gameObject.GetComponent<PlayerHP>().ov==true || 	GameObject.Find ("Player").gameObject.GetComponent<PlayerHP>().BossDie == true) 
		{
			//Time.timeScale = 0.0f;
